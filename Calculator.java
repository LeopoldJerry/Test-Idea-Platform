...
public class Calculator {
    ...
    public static Duration getFlyTime(Ticket tickets) {
        ZonedDateTime departureTime = getTime(
                tickets.getDeparture_date(),
                tickets.getDeparture_time(),
                tickets.getOrigin());
        ZonedDateTime arrivalTime = getTime(
                tickets.getArrival_date(),
                tickets.getArrival_time(),
                tickets.getDestination());
